...
<ol class="breadcrumb u-margin-top">
  ...
  <li><a href="${linkTo[MapStudyController].show(criteria.mapStudy.id)}"><fmt:message key="mapstudy.details"/></a></li>
  <li><a href="${linkTo[MapStudyController].planning(criteria.mapStudy.id)}"><fmt:message key="mapstudy.planning"/></a></li>
  <li class="active"><fmt:message key="mapstudy.exclusion.criteria.remove"/></li>
</ol>


<h3 class="color-primary">
	<fmt:message key="mapstudy.exclusion.criteria.remove"/> - ${criteria.description}
	<a id="return" class="btn btn-default pull-right" href="${linkTo[MapStudyController].planning(criteria.mapStudy.id)}"><fmt:message key="button.back"/></a>
</h3>
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<b><fmt:message key="mapstudy.exclusion.criteria"/></b>
			</div>
			<!-- /.panel-heading -->
			<div class="panel-body">
				...
				<p>
					<strong>
						<fmt:message key="mapstudy.exclusion.criteria.remove"/>:
					</strong> 
					
					<form action="${linkTo[MapStudyController].removeexclusioncriteria}" method="post">
					...
					<table class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<th><fmt:message key="mapstudy.exclusion.criterias" /></th>
							</tr>
						</thead>
						<tbody>
